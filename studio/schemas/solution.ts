...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      title: "Module / Modül",
      type: "string",
      options: { list: ["FI", "CO", "MM", "SD", "PS", "FM", { title: "E-Çözümler (e-Dönüşüm)", value: "E" }] },
    ...
    defineField({
      ...
      title: "Group / Grup",
      type: "string",
      options: { list: [{ title: "Finans", value: "fin" }, { title: "Lojistik", value: "log" }, { title: "E-Çözümler", value: "edon" }] },
      validation: (r) => r.required(),
    }),
    ...
    defineField({
      name: "references",
      title: "Bu çözümü kullanan referanslar",
      type: "array",
      of: [defineArrayMember({ type: "reference", to: [{ type: "clientReference" }] })],
      description: "Çözüm detay sayfasında logolarıyla listelenir.",
    }),
