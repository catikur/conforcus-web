...
export const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    desc_tr: "Sahada kanıtlanmış, kurulmaya hazır 55+ SAP çözümü ve e-dönüşüm paketleri. Modül seçerek filtrelenmiş kataloğa gidin.",
    desc_en: "55+ field-proven, ready-to-deploy SAP solutions and e-transformation packages. Pick a module to open the filtered catalog.",
    cta_tr: "Tüm katalog →",
    cta_en: "Full catalog →",
    cols3: true,
    links: [
